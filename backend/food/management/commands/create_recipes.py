...
class Command(BaseCommand):
    help = 'Load data into the database from CSV and image files and create a superuser'

    def add_arguments(self, parser):
        parser.add_argument('--ingredients', type=str, help='Path to the ingredients CSV file')
        parser.add_argument('--image', type=str, help='Path to the example image file')
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('All recipes created successfully!'))
